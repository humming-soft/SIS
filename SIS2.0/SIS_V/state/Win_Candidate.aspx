            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.d.length; i++) {
                        ...
                        var twist = '<div class="grid-item"> <div class="ibox"><a href="' + url + '" class="txt-inherit redir"><div class="ibox-content bg-info txt-black"><div class="ibox-top"><h4 class="font-bold">PARLIMEN</h4><p class="f-w-600 ta-center">' + $dist + '</p></div><div class="ibox-bottom"><h4 class="font-bold">DUN</h4><div class="rest-height-65 scroll" style="overflow-y:auto;">' + $sub + '</div></div></div></a></div></div>';
                        $container += twist;
                    }
                    $("#par").html($container);
                },
