...
{
    public partial class candidate_profilelist : System.Web.UI.Page
    {
        ...
        public void fill_dt()
        {
            ...
            final.Columns.Add("candidate_id", typeof(string));
        ...
        protected void GridCInfo_PreRender(object sender, EventArgs e)
        {
            if (GridCInfo.Rows.Count > 0)
            {
