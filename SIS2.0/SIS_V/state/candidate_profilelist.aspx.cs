    ...
    public partial class candidate_profilelist : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (ddlNameC.SelectedIndex != 0)
            {
                ...
                dt_all = objBUS.GetCandidateSearchList();

                final_all.Columns.Add("candidate_id", typeof(string));
                final_all.Columns.Add("image", typeof(string));
                final_all.Columns.Add("title", typeof(string));
                ...
                if (dt_all.Rows.Count > 0)
                {
                    ...
                    {
                        string base64String = "";
                        if (dt_all.Rows[i]["image"].ToString() == "")
                        {
                            base64String = "";
                        }
                        else
                        {
                            byte[] bytes = (byte[])dt_all.Rows[i]["image"];
                            if (bytes.Length > 0)
                            {
                                base64String = Convert.ToBase64String(bytes, 0, bytes.Length);
                            }
        ...
        protected void lnkedit_Click(object sender, EventArgs e)
        {
            ...
            string old_ic = row.Cells[2].Text;
