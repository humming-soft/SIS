...
namespace SIS_V.state
{
    public partial class laporan_harian_add : System.Web.UI.Page
    {
        ...
        public void fill_kodkawasan()
        {
            ...
            ddlKodKawasan.Items.Insert(0, new ListItem("---PILIH---", ""));

            ddlKod_KawasanI.DataSource = dt;
            ddlKod_KawasanI.DataBind();
            ddlKod_KawasanI.Items.Insert(0, new ListItem("---PILIH---", ""));

            ddlKodKawasanj.DataSource = dt;
            ddlKodKawasanj.DataBind();
            ddlKodKawasanj.Items.Insert(0, new ListItem("---PILIH---", ""));

            ddlKodKawasanIn.DataSource = dt;
            ddlKodKawasanIn.DataBind();
            ddlKodKawasanIn.Items.Insert(0, new ListItem("---PILIH---", ""));

            ddlKodKawasanKawasan.DataSource = dt;
            ddlKodKawasanKawasan.DataBind();
            ddlKodKawasanKawasan.Items.Insert(0, new ListItem("---PILIH---", ""));
        }
        ...
        public void fill_jenis()
        {
            ...
            ddlAktiviti.Items.Insert(0, new ListItem("---PILIH---", ""));
        }
        ...
        public void fill_parti()
        {
            ...
            ddlparti.DataBind();
            ddlparti.Items.Insert(0, new ListItem("---PILIH---", ""));

            ddlPartiI.DataSource = dt2;
            ddlPartiI.DataBind();
            ddlPartiI.Items.Insert(0, new ListItem("---PILIH---", ""));

            ddlPartiIn.DataSource = dt2;
            ddlPartiIn.DataBind();
            ddlPartiIn.Items.Insert(0, new ListItem("---PILIH---", ""));
        }
        ...
        public void fill_isu()
        {
            ...
            ddlKategoriIsu.Items.Insert(0, new ListItem("---PILIH---", ""));
        }
        public void fill_status()
        {
            ...
            ddlstatusKawasan.Items.Insert(0, new ListItem("---PILIH---", ""));
        }
        ...
        protected void btnsimpan1_Click(object sender, EventArgs e)
        {
            ...
            for (int k = 0; k < counter; k++)
            {
                ...
                objAktivitiBUS.tarikh = DateTime.ParseExact(split_itarikh[k], "dd/MM/yyyy HH:mm", null);
        ...
        protected void btnsimpan2_Click(object sender, EventArgs e)
        {
            ...
            for (int l = 0; l < counter; l++)
            {
                ...
                objAktivitiBUS.tarikh = DateTime.ParseExact(split_jtarikh[l], "dd/MM/yyyy HH:mm", null);
        ...
        protected void btnsimpan3_Click(object sender, EventArgs e)
        {
            ...
            for(int m = 0; m < counter; m++)
            {
                ...
                objAktivitiBUS.tarikh = DateTime.ParseExact(split_Intarikh[m], "dd/MM/yyyy HH:mm", null);
        ...
        protected void btnsimpan4_Click(object sender, EventArgs e)
        {
            ...
            for (int n = 0; n < counter; n++)
            {
                ...
                objAktivitiBUS.tarikh = DateTime.ParseExact(split_tarikhKawasan[n], "dd/MM/yyyy HH:mm", null);
