                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <asp:Label ID="LabPollDistrict" runat="server" Text=""></asp:Label>
<%--                                <asp:DropDownList ID="DropDownList4" CssClass="form-control" runat="server">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <asp:Label ID="LabLocaliti" runat="server" Text=""></asp:Label>
...
<%--                                <asp:TextBox ID="TextBox1" CssClass="form-control" runat="server"></asp:TextBox>--%>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="TextComment" CssClass="form-control" runat="server" Style="width: 100%; min-height: 200px" TextMode="MultiLine"></asp:TextBox>
    ...
    <%--                <div class="row m-t-15">
                    ...
                    <div class="form-group text-left m-b-0 m-t-15">
                        <asp:Button ID="saveJustification" runat="server" CssClass="btn btn-primary waves-light" Text="Simpan" OnClick="saveJustification_Click" />
                        <asp:Button ID="cancel" runat="server" CssClass="btn btn-default waves-light m-l-5" Text="Batal" OnClick="cancel_Click" />
                    </div>
                 </div>
            </div>
        </div>
